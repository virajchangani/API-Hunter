...
//     try {
//       const response = await axios.get("http://localhost:1000/posts");
...
//     try {
//       const addData = await axios.post("http://localhost:1000/posts", { 
//         title, 
//         filed, 
//         subject, 
//         marks, 
...
//     if (selectedId !== null) {
//       try {
//         const updatedData = await axios.put(`http://localhost:1000/posts/${selectedId}`, { 
//           title, 
//           filed, 
//           subject, 
//           marks, 
